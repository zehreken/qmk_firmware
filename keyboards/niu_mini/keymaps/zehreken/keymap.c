...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_planck_mit(
		...
		KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, TO(0),     KC_SPC,     TO(2), KC_LEFT, KC_RGHT, KC_UP,   KC_DOWN
  ),
	...
	[1] = LAYOUT_planck_mit( // NOT USED
		...
		RESET,   _______, _______, _______, _______,     _______,      _______, _______, KC_MUTE, KC_VOLU, KC_VOLD
	),
	...
	[2] = LAYOUT_planck_mit(
		...
		_______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, _______, KC_LBRC, KC_RBRC, KC_BSLS, KC_QUOT, _______, _______,
